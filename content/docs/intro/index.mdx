---
title: Introduction
description: The Kinetra framework for building motion control applications in Rust.
icon: Lightbulb
authors:
  - Phil
  - Yancey
...
<Showcases cols={2}>
  ...
  <Showcase title="Unified fieldbus orchestration" icon={<NetworkIcon />}>
    Blend EtherCAT devices, Mesa cards, and custom KinetraMCU boards into one coherent system without compromising on determinism.
  </Showcase>
